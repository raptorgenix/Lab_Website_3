...
app.get('/player_info/post', function(req, res) {
	var games = 'SELECT COUNT(*) FROM (SELECT id FROM football_players, football_games ' + 'WHERE football_players.id = ANY(football_games.players)) ' + 'AS plyrs WHERE plyrs.id = ' + req.query.player_choice + ';';
	var onePlayer = 'SELECT * FROM football_players WHERE football_players.id = ' + req.query.player_choice + ';';
